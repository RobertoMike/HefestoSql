 ...
 * @param <W> is the where object
 */
@SuppressWarnings("unchecked")
public interface ConditionalBuilder<R extends ConditionalBuilder<R, W>, W extends ConstructWhere> {

    /**
     * Returns the 'Wheres' object.
     *
     * @return  the 'Wheres' object
     */
    W getWheres();
