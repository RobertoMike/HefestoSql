...
mavenPublishing {
    ...
    pom {
        name.set("HefestoSql - Hibernate Criteria Builder")
        description.set("HefestoSql Hibernate Criteria Builder - an open-source Kotlin/Java library for creating queries with Hibernate")
